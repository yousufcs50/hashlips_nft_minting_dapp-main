# NFT-mint
a minting page for an NFT using react and nodejs

![image](https://user-images.githubusercontent.com/52100471/206994721-611a3eda-a190-4b23-8e87-74958f27c345.png)

To run the project   

1.Clone the repository   
2. Make sure nodejs is installed.   
3. in the root folder type:
```
npm i
